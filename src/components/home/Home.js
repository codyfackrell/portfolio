...
export default function Home() {
   ...
   return (
      <Box component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box>
            <h1>Hi, I'm  NOT ME <span style={{background: info.gradient, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>{info.firstName}</span><span className={Style.hand}>🤚🏼</span>
            </h1>
            ...
            <Box display={'flex'} gap={'1.5rem'} fontSize={{xs: '2rem', md: '2.5rem'}} alignItems={'center'} justifyContent={{xs: 'center', md: 'flex-start'}}>
